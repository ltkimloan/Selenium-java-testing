...
public class Topic_11_Custom_Radio_Checkbox {
	...
	public void TC_01_() {
		...
		// thẻ input lại dùng để verify được = >> vì hàm isselectect chỉ dùng với thẻ input//
	...
	public void TC_02_() {
		...
		// thẻ này lại k dùng để verify được = >> vì hàm isselectect chỉ dùng với thẻ input//
	...
	public void TC_03_() {
		...
		// Chỉ sd cho trường hợp viết basuc/demo //
		// nếu apply vào 2 framwork/ dự án thực tế thì không nên
		// vì 1 element phải define tới nhiều locator, dễ bị hiểu nhầm hoặc mất thòi gian maintain
	...
	public void TC_04_() {
		...
		// selenium cung cấp 1 thư viện để nhúng đoạn code JavaScript =>> JavaScriptExcutor
