...
public class Topic_05_Web_Browser_PI {
	...
	public void TC_01_() {
		...
		// Có thể lưu/ gán dữ liệu vào 1 biến để thực hiện cho các step sau ( dùng lại
		// nhiều lần trên cùng 1 element)
		WebElement emailTextBox = driver.findElement(By.xpath("[//input@id='email']")); // khúc này nhớ lưu lại sau khi
																						// import
